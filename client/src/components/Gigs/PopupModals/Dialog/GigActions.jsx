...
import { publishGig } from "components/Gigs/API/RocketChat/RocketChat";
...
class GigActions extends React.Component {
  ...
  publishGig() {
    ...
    const { gig } = this.props;
    publishGig(gig._id, this.setStatusState);
  }
  ...
  cancelGig() {
    ...
    cancel(gig._id, gig.rc_channel_id._id, cancelPayload, this.setStatusState);
  }
              ...
              <React.Fragment>
                ...
                >
                  <p style={{ textAlign: "justify" }}>
                    Are you sure you want to cancel this gig? To reinstate this
                    gig later on, please contact the super admin
                  </p>
                </GridItem>
                <GridItem
                  xs={10}
            ...
            {status === "working" ? (
              <React.Fragment>
                ...
                >
                  ...
                  >
                    Publishing the gig sets the status to "Active", making the
                    Rocket Chat group public.
                  </p>
                </GridItem>
                ...
                <GridItem xs={10} sm={10} md={10} lg={10}>
                  ...
                  >
                    <CardBody>
                      <Button
                        className={classes.marginRight}
                        onClick={() => {
                          this.setStatusState("cancelling");
                        }}
                        color="danger"
                  ...
                  <div style={{ overflow: "auto", display: "block" }}>
                    ...
                    <p style={{ textAlign: "justify", fontSize: 13 }}>
                      Cancelling the gig disables the gig. This action cannot be
                      undone.
                    </p>
                  </div>
                </GridItem>
